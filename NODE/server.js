...
//inicio middleware tiene que estar arriba de todos los endpoints 
...
app.post('/login', async (req,res)=>{
    try{
        const {username,password}=req.body //coge los datos que hemos introducido por el formulario
